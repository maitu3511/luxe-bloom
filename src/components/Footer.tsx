...
const socialLinks = [
  { icon: MessageCircle, href: "https://wa.me/11234567890", label: "WhatsApp" },
  { icon: Instagram, href: "https://instagram.com/luxesalon", label: "Instagram" },
  { icon: Facebook, href: "https://facebook.com/luxesalon", label: "Facebook" },
];
